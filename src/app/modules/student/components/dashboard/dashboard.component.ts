...
export class DashboardComponent {
  ...
  subjects: Subjects[] = [ 
    {subject:"Pro"},{subject:"Pro"},{subject:"Pro"},
    {subject:"Pro"},{subject:"Pro"},{subject:"Pro"},
    {subject:"Pro"},{subject:"Pro"},
  ];
  ...
  cardsInProgress: Card[] = [
    { image: "image-url-1", title: "IN PROGRESS", description: "Description 1" },
    { image: "image-url-2", title: "IN PROGRESS", description: "Description 2" },
    { image: "image-url-3", title: "IN PROGRESS", description: "Description 3" },
    { image: "image-url-3", title: "TO-DO", description: "Description 3" }
  ];
